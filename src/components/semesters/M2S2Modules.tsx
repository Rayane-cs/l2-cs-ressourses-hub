...
export default function M2S2Modules({ showHeader = true }: Props) {
  return (
    <section id="modules-m2-s2" className="py-12 bg-background">
      <div className="container mx-auto px-4">
        {showHeader && (
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">M2 - Semester 2</h2>
