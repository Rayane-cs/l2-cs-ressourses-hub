...
export default function L3S5Modules({ showHeader = true }: Props) {
  return (
    <section id="modules-l3-s5" className="py-12 bg-background">
      <div className="container mx-auto px-4">
        {showHeader && (
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">L3 - Semester 5</h2>
